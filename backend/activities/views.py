    ...
    def get(self, request):
        ...
        return Response({
            ...
            "summary": {
                ...
                "around_earth": round(total_distance / 1000 / 36788, 2),
                "way_to_the_moon": round(total_distance / 1000 / 384000, 3),
                ...
                "days_since_first_activity": days_since_first_activity,
                "weeks_since_first_activity": weeks_since_first_activity,
                "months_since_first_activity": months_since_first_activity,
