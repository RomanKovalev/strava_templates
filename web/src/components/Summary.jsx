...
const Summary = () => {
  ...
  return (
      <div className="flex-grow">
          ...
          <br/>
          <p>
              I recorded a total distance of {summary.total_distance} km ({summary.around_earth} trips
              around the world 🌍 and {summary.way_to_the_moon} trips to the moon 🌕),
              an elevation of {summary.total_elevation} m ({summary.everest_elevation} times Mount Everest 🏔)
              and a total time
              of {summary.total_elapsed_time_weeks}w {summary.total_elapsed_time_days}d {summary.total_elapsed_time_hours}h {summary.total_elapsed_time_minutes}m
              🎉.
          </p>
          <br/>
          <p>
